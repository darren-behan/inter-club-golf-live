...
function UpdateMatch() {
  ...
  const inputFieldValues = [
    ...
    },
    {
      ...
      autoComplete: 'autoComplete',
      autoFocus: false,
      value: !isEmpty(updateMatchObj.neutralVenueName)
        ? Lib.capitalize(updateMatchObj.neutralVenueName)
        : updateMatchObj.neutralVenueName,
      disabled: false,
      type: '',
      select: false,
              ...
              <>
                <div id={i}>
                  <TextField
                    ...
                    helperText={`Match ${individualMatch.individualMatchId}: Update ${Lib.capitalize(
                      homeTeamName,
                    )} player name`}
                  />
                  <TextField
                    ...
                    helperText={`Match ${individualMatch.individualMatchId}: If the ${Lib.capitalize(
                      homeTeamName,
                    )} player is winning, enter the number of holes they are up by, otherwise, enter 0`}
                  />
                  <TextField
                    className={classes.textField}
                    key={i + 1}
              ...
              <>
                <div id={i}>
                  ...
                  <TextField
                    ...
                    helperText={`Match ${individualMatch.individualMatchId}: If the ${Lib.capitalize(
                      homeTeamName,
                    )} players are winning, enter the number of holes they are up by, otherwise, enter 0`}
                  />
                  <TextField
                    className={classes.textField}
                    key={i + 1}
